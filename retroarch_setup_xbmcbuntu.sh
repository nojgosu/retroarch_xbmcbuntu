...
function install_xboxdrv()
{
    ...
    #TODO: write up the enable keyvalues to configure the xbox controllers
    #also write up the quit key combination
}
